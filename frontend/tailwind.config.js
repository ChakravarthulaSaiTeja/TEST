  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 24px rgba(0,224,164,0.16)',
        'glow-secondary': '0 0 24px rgba(0,200,255,0.16)',
        'floating': '0 20px 40px rgba(2,6,23,0.4)',
